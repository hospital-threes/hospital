...
Page({
  ...
  freetijiao:function(e){
    ...
    wx.navigateTo({
      url: '/pages/online_registration/successfulConsulting/successfulConsulting',
    })
  ...
  submitPay:function(id){
    ...
    wx.navigateTo({
      url: '/pages/online_registration/consultingPaid/consultingPaid?jsonStr=' + str + '&consultationId=' + consultationId + '&orderNum=' + orderNum,
    })
  },
